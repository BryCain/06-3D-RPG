...
func _physics_process(_delta):
	...
	if Global.timer < 0:
		get_tree().change_scene("res://UI/Game_Over.tscn")
	if get_node_or_null("/root/Game/Target_container").get_child_count() == 0 and get_node_or_null("/root/Game/Drone_container").get_child_count() == 0:
...
func damage():
	...
	get_node_or_null("/root/Game/UI").add_damage(0.5)
